...
var _Connection_instances, _Connection_transport, _Connection_delay, _Connection_timeout, _Connection_closed, _Connection_callbacks, _Connection_contexts, _Connection_maybeEmitOnContext, _Connection_onClose;
...
class Connection extends EventEmitter_js_1.EventEmitter {
    ...
    registerContext(context) {
        __classPrivateFieldGet(this, _Connection_contexts, "f").set(context.id, context);
    }
    unregisterContext(context) {
        __classPrivateFieldGet(this, _Connection_contexts, "f").delete(context.id);
    }
    dispose() {
