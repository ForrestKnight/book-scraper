...
export class BrowserContext extends BrowserContextBase {
    ...
    async newPage() {
        ...
        const page = await Page._create(__classPrivateFieldGet(this, _BrowserContext_connection, "f"), result);
    ...
    async close() {
        ...
        __classPrivateFieldSet(this, _BrowserContext_pages, new Map(), "f");
    }
}
