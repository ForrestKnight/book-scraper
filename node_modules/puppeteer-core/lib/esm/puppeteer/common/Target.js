...
var _Target_browserContext, _Target_session, _Target_targetInfo, _Target_sessionFactory, _Target_targetManager, _PageTarget_defaultViewport, _PageTarget_screenshotTaskQueue, _PageTarget_ignoreHTTPSErrors, _WorkerTarget_workerPromise;
...
_Target_browserContext = new WeakMap(), _Target_session = new WeakMap(), _Target_targetInfo = new WeakMap(), _Target_sessionFactory = new WeakMap(), _Target_targetManager = new WeakMap();
/**
 * @internal
 */
